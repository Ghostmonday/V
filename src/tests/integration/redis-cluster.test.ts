...
import { createRedisClient, parseRedisConfig, checkRedisHealth, type RedisClusterConfig } from '../../config/redis-cluster.js';
...
describe('Redis Failover Scenarios', () => {
  ...
  it('should handle reconnection attempts', () => {
    ...
    const reconnectCall = mockClient.on.mock.calls.find((call: any[]) => call[0] === 'reconnecting');
