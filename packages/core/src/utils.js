 ...
 */
export function anonymizeUserId(userId, salt) {
 ...
 * @returns Anonymized hash
 */
export function anonymizeEmail(email, salt) {
 ...
 * @returns Anonymized hash
 */
export function anonymizePhone(phone, salt) {
 ...
 */
export function anonymizePII(data, fields = ['email', 'phone', 'userId'], salt) {
 ...
 * @returns Salt string
 */
export function generateUserSalt(userId) {
